...
const Mod8Sec1 = () => {
  return (
    <div className="introduction-content">
        <h3>Lesson 1: Understanding Diversity and Inclusivity in AI</h3>
        ...
        <h4>1. Definition and Importance</h4>
        <h5>1.1 Defining Diversity in AI</h5>
        <p>
        ...
        <h5>1.2 Defining Inclusivity in AI</h5>
        ...
        <h5>1.3 Significance of Diversity and Inclusivity in AI Development</h5>
        <ul>
        ...
        <h5>2.1 Exclusion of Diverse Voices</h5>
        <p>
        ...
        <h5>2.2 Implications of Exclusion on AI Systems</h5>
